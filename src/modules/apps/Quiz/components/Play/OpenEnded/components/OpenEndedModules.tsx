...
const PureOpenEndedModules: React.FC<OpenEndedModulesProps> = ({ game }) => {
...
const OpenEndedModules = React.memo(
  PureOpenEndedModules,
  (prevProps, nextProps) => {
    return (
      prevProps.game.id === nextProps.game.id &&
      prevProps.game.questions.length === nextProps.game.questions.length
    );
  }
);
